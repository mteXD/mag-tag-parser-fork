...
static inline std::string
    error_msg(const symbol_t &s, const std::string expected);

static inline symbol_t &
    peek(std::vector<symbol_t> &symbols, const std::string err);
static inline symbol_t &
    consume(std::vector<symbol_t> &symbols, const std::string err);

static void add_leaf(
    dertree_t &t, std::vector<symbol_t> &symbols, Term expected_symbol,
