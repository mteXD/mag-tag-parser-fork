...
std::shared_ptr<ast_node_t> ast_construct(
    const dertree_t &node, std::shared_ptr<ast_node_t> arg
) {
    switch (node.label) {
        case Nont::SOURCE:
            {
                auto ps     = std::make_shared<ast_source_t>();
                auto pdecls = std::dynamic_pointer_cast<ast_decls_t>(
        ...
        case Nont::DECLREST:
            {
                ...
                auto pdecl
                    = std::dynamic_pointer_cast<ast_decl_t>(ast_construct(
                        node.subtrees.at(0), std::shared_ptr<ast_node_t>()
                    ));
                pdecls->add(pdecl);
                auto prest = std::dynamic_pointer_cast<ast_decls_t>(
                    ast_construct(node.subtrees.at(1), nullptr)
                );
        ...
        case Nont::BASIC:
            {
                ...
                auto e   = std::dynamic_pointer_cast<ast_edge_t>(
                    ast_construct(node.subtrees.at(0), nullptr)
                );
                ptb->add_edge(e);
                auto es = std::dynamic_pointer_cast<ast_edges_t>(
                    ast_construct(node.subtrees.at(1), nullptr)
                );
        ...
        case Nont::EDGE:
            return std::make_shared<ast_edge_t>(
                node.leaves.at(0).name, node.leaves.at(2).name
            );
        case Nont::EDGEREST:
            {
        ...
        case Nont::LINEAR:
            {
                ...
                ptl->add_tag(pt);
                auto prest = std::dynamic_pointer_cast<ast_topology_linear_t>(
                    ast_construct(node.subtrees.at(0), nullptr)
                );
        ...
        case Nont::EXPR:
            {
                auto pe = std::dynamic_pointer_cast<ast_expr_t>(
                    ast_construct(node.subtrees.at(0), nullptr)
                );
        ...
        case Nont::SUMREST:
            {
                ...
                auto prhs = std::dynamic_pointer_cast<ast_expr_t>(
                    ast_construct(node.subtrees.at(0), nullptr)
                );
                auto expr = std::make_shared<ast_expr_bin_t>(
                    ((node.label == Nont::SUMREST) ? ast_expr_bin_t::Oper::SUM
                                                   : ast_expr_bin_t::Oper::MUL),
        ...
        case Nont::PG:
            {
                ...
                auto pg = std::dynamic_pointer_cast<ast_pg_t>(
                    ast_construct(node.subtrees.at(0), nullptr)
                );
                if (!pg) {
                    return nullptr;
        ...
        case Nont::PG_REST:
            {
                ...
                return std::make_shared<ast_pg_t>(
